...
// tạo ra một mảng budgets “đã được ghép thêm dữ liệu category”
// ban đầu 1 object budget chỉ lưu thuộc tính categoryId
// hàm này ghép thêm object category tương ứng (lấy bằng gtri categoryId của budget) vào object budget đó
export const withCategory = (budgets = [], categoryById) =>
