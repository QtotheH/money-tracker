...
const ExpenseChartFilter = () => {
  return (
    <div className="flex items-r border rounded-full p-0.5 sm:p-1 bg-white shadow-sm gap-0.5 sm:gap-0">
        ...
        {/* Nút Chi tiêu */}
        <button title="Xem Chi Tiêu" className="flex items-center justify-center w-8 h-7 sm:w-10 sm:h-8 rounded-full text-orange-500 transition-colors hover:bg-orange-50">
